...
import type { IdentityData, Virtue } from '../data';
...
export const SubtabIdentityCardInfo = (props) => {
  const { act, data } = useBackend<IdentityData>();
    ...
    <Section title="Info">
      <LabeledList>
        ...
        <LabeledList.Item label="Pronouns">
          <Button
            icon={PRONOUN_TO_ICON[data.pronouns]}
            fluid
            style={{
        ...
        <LabeledList.Item label="Titles">
          <Button
            icon={TITLEPREF_TO_ICON[data.titles_pref]}
            fluid
            onClick={() => act('titles')}
          >
            {data.titles_pref}
        ...
        <LabeledList.Item label="Clothing">
          <Button
            icon={CLOTHESPREF_TO_ICON[data.clothes_pref]}
            fluid
...
export const SubtabIdentityCardSpecies = (props) => {
  ...
  return (
    <Section
      ...
      buttons={
        <LabeledListLikeTooltip
          tooltip="Selecting species or subspecies will reset all visual features."
          fontSize={1.2}
        >
...
export const SubtabIdentityCardFaith = (props) => {
  ...
  return (
    <Section
      title={'\u16C9 Faith \u16E3'}
      className="PreferencesMenu__Section__Faith"
    >
      <LabeledList>
        {/* TODO: in-menu selection */}
...
export const SubtabIdentityCardVirtues = (props) => {
  ...
  return (
    <Section className="PreferencesMenu__Section__Virtues" title="Virtues">
      <Stack vertical>
        <Stack.Item>
        ...
        {/* TODO: this should not require downstream edits in-UI to function */}
      </Stack>
    </Section>
  );
};
...
export const SubtabIdentityCardVices = (props) => {
  ...
  if (!constantData) {
    return (
      <Section className="PreferencesMenu__Section__Vices" title="Vices">
        <LoadingScreen />
      </Section>
    );
  }

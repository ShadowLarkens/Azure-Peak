import { ColorButton, ensureColorHash, HeadshotButton } from 'pm/components';
...
export const SubtabVillain = () => {
  const { data } = useBackend<VillainData>();
...
const VillainSettings = () => {
  const { act, data } = useBackend<VillainData>();
  const {
    lich_headshot_link,
      ...
      <LabeledList>
        ...
        {preset_bounty_enabled ? (
          <>
            ...
            <LabeledList.Item label="Crime Severity (Vagabond)">
              <Button
